...
#include <stdio.h>
#include <string.h>
#include "./code/build/include/curl/curl.h"
 
char *data =  "{  \"id\": 123,  \"category\": {    \"id\": 0,    \"name\": \"string\"  },  \"name\": \"haha1233\",  \"photoUrls\": [    \"string\"  ],  \"tags\": [    {      \"id\": 0,      \"name\": \"string\"    }  ],  \"status\": \"available\"}";
